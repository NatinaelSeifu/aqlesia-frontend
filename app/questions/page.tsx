...
export default function QuestionsPage() {
  ...
  const handleEditQuestion = async () => {
    ...
    try {
      setError("")
      await questionsService.updateMyQuestion(selectedQuestion.id, { question: editForm.question })
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-8 bg-white">
        <div className="mb-8 text-center">
          ...
          <h2 className="text-3xl font-bold mb-2 text-slate-800">My Questions</h2>
          <p className="text-blue-600 max-w-2xl mx-auto">Ask questions and get answers from the church administration</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <Card className="border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100 shadow-lg">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
                <CardTitle className="text-base font-semibold text-blue-900">Total Questions</CardTitle>
              ...
              <CardContent>
                ...
                <p className="text-sm text-blue-700 mt-1">Questions submitted</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-green-200 bg-gradient-to-br from-green-50 to-green-100 shadow-lg">
              ...
              <CardContent>
                ...
                <p className="text-sm text-green-700 mt-1">Received responses</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-purple-200 bg-gradient-to-br from-purple-50 to-purple-100 shadow-lg">
              ...
              <CardContent>
                ...
                <p className="text-sm text-purple-700 mt-1">Completed questions</p>
              </CardContent>
            </Card>
          </div>
        )}
        ...
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-xl font-semibold text-slate-800">Your Questions</h3>
          <div className="flex gap-3">
            ...
            <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
              ...
              <DialogContent className="bg-white">
                <DialogHeader>
                  <DialogTitle className="text-slate-800">Ask a Question</DialogTitle>
                  <DialogDescription className="text-blue-600">
                    Submit your question and get an answer from the church administration.
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="create_question" className="text-sm font-medium text-blue-700">Your Question</Label>
                    <Textarea
                      id="create_question"
                      value={createForm.question}
                      onChange={(e) => setCreateForm({ question: e.target.value })}
                ...
                <DialogFooter>
                  <Button onClick={() => setCreateDialogOpen(false)} className="bg-gradient-to-r from-slate-100 to-slate-200 hover:from-slate-200 hover:to-slate-300 text-slate-700 border-0 font-medium shadow-sm">
                    Cancel
                  </Button>
                  <Button onClick={handleCreateQuestion} className="bg-amber-600 hover:bg-amber-700 text-white">
                    Submit Question
                  </Button>
                </DialogFooter>
              </DialogContent>
        ...
        <div className="space-y-4">
          {loadingQuestions ? (
            ...
            <Card className="border-blue-200 shadow-sm bg-white">
              <CardContent className="flex flex-col items-center justify-center py-16">
                ...
                <p className="text-blue-600 text-center mb-6">
                  you can any question for ቀሲስ, so ቀሲስ will answer it.
                </p>
                <Button 
            ...
            questions.map((question) => (
              <Card key={question.id} className="border-blue-200 shadow-lg hover:shadow-xl transition-all duration-200 bg-gradient-to-br from-white to-blue-50">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent className="bg-white">
                            ...
                            <AlertDialogFooter>
                              <AlertDialogCancel className="bg-gradient-to-r from-slate-100 to-slate-200 hover:from-slate-200 hover:to-slate-300 text-slate-700 border-0 font-medium shadow-sm">Cancel</AlertDialogCancel>
                              <AlertDialogAction 
        ...
        {questions && questions.length > 0 && (
          <div className="mt-4 text-center">
            <p className="text-sm text-slate-600 mb-2">
              Page {currentPage} of {totalPages} | Total Questions Available: {totalPages * pageSize} | Current Page: {questions.length} items
            </p>
          </div>
        )}
        ...
        <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
          <DialogContent className="bg-white">
            <DialogHeader>
              <DialogTitle className="text-slate-800">Edit Question</DialogTitle>
              <DialogDescription className="text-blue-600">
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="edit_question" className="text-sm font-medium text-blue-700">Your Question</Label>
                <Textarea
                  id="edit_question"
            ...
            <DialogFooter>
              <Button onClick={() => setEditDialogOpen(false)} className="bg-gradient-to-r from-slate-100 to-slate-200 hover:from-slate-200 hover:to-slate-300 text-slate-700 border-0 font-medium shadow-sm">
                Cancel
              </Button>
              <Button onClick={handleEditQuestion} className="bg-blue-600 hover:bg-blue-700 text-white">
                Update Question
              </Button>
            </DialogFooter>
          </DialogContent>
