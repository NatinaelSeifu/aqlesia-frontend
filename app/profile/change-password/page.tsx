    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-8 bg-white">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold mb-2 text-gray-900">Change Password</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">Update your password to keep your account secure</p>
        </div>
        <ChangePassword 
