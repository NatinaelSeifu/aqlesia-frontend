...
export function UserProfile() {
  ...
  const addChild = () => {
    if (childName.trim() && !formData.childrens_name.includes(childName.trim())) {
      ...
      setError("This child name already exists")
    ...
    <Card className="w-full max-w-4xl mx-auto border-gray-200 shadow-lg bg-white overflow-hidden">
      <CardHeader className="bg-gradient-to-r from-gray-50 to-white border-b border-gray-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-gray-900 text-xl">Personal Information</CardTitle>
        ...
        <form key={currentUser?.id} onSubmit={handleSubmit} className="space-y-8">
          ...
          {success && (
            <Alert className="border-green-200 bg-green-50">
              ...
              <AlertDescription className="text-green-700 font-medium">{"Profile updated successfully!"}</AlertDescription>
            </Alert>
          )}
          ...
          <div className="bg-white border-2 border-gray-300 rounded-lg p-6 space-y-4 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-gray-800 font-semibold text-sm">{"ስም"}</Label>
                <Input
                  id="name"
                  value={formData.name}
                  onChange={(e) => handleChange("name", e.target.value)}
                  placeholder={currentUser?.name || "ስምን ያስገቡ"}
              ...
              <div className="space-y-2">
                <Label htmlFor="lastname" className="text-gray-800 font-semibold text-sm">{"ክ/ስም"}</Label>
                <Input
                  id="lastname"
                  value={formData.lastname}
                  onChange={(e) => handleChange("lastname", e.target.value)}
                  placeholder={currentUser?.lastname || "ክ/ስምን ያስገቡ"}
                  className="bg-white border-2 border-gray-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 text-gray-900 font-medium"
                  required
                />
              </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="phone" className="text-gray-800 font-semibold text-sm">{"ስልክ"}</Label>
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder={currentUser?.phone_number || "ስልክ ሰክን ያስገቡ"}
          ...
          <div className="bg-white border-2 border-gray-300 rounded-lg p-6 space-y-4 shadow-sm">
            ...
            <div className="space-y-2">
              <Label htmlFor="job_title" className="text-gray-800 font-semibold text-sm">{"የስራ አይነት"}</Label>
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder={currentUser?.job_title || "e.g. Software Engineer, Teacher, Doctor"}
                  className="pl-10 bg-white border-2 border-gray-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 text-gray-900 font-medium"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="education" className="text-gray-800 font-semibold text-sm">{"የትምህርት ደረጃ"}</Label>
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder={currentUser?.education || "e.g. Bachelor's Degree, Master's Degree"}
                  className="pl-10 bg-white border-2 border-gray-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 text-gray-900 font-medium"
                />
              </div>
            </div>
          ...
          <div className="bg-white border-2 border-gray-300 rounded-lg p-6 space-y-4 shadow-sm">
            ...
            <div className="space-y-2">
              <Label htmlFor="marriage_status" className="text-gray-800 font-semibold text-sm">{"Marriage Status"}</Label>
              <Select
              ...
              >
                <SelectTrigger className="!bg-white border-2 border-gray-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 text-gray-900 font-medium">
                  <div className="flex items-center">
                    ...
                    <SelectValue placeholder={currentUser?.marriage_status ? `Current: ${currentUser.marriage_status}` : "Select marriage status"} />
                  </div>
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              <Label htmlFor="partner_name" className="text-gray-800 font-semibold text-sm">{"የአጋር ስም"}</Label>
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder={currentUser?.partner_name || "የአጋርዎን ስም ያስገቡ"}
                  className="pl-10 bg-white border-2 border-gray-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 text-gray-900 font-medium"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <Label className="text-gray-800 font-semibold text-sm">{"የልጆች ስም"}</Label>
              <div className="flex space-x-2">
                <Input
                  value={childName}
                  onChange={(e) => setChildName(e.target.value)}
                  placeholder={formData.childrens_name.length > 0 ? "ለላልት የልጅ ስም ይጨምሩ" : "የልጅ ስም ያስገቡ"}
                  className="bg-white border-2 border-gray-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 text-gray-900 font-medium"
              ...
              {formData.childrens_name.length > 0 && (
                <div className="space-y-2">
                  <p className="text-sm text-muted-foreground">
                    Current children ({formData.childrens_name.length}):
                  </p>
